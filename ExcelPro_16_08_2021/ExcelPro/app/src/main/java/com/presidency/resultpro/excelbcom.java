...
public class excelbcom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_excelbcom);
        ebcom = findViewById(R.id.uploadmarklist);
        //click on excel to select a file
        ebcom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(ActivityCompat.checkSelfPermission(excelbcom.this , Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    selectfile();
                }
                else {
                    ActivityCompat.requestPermissions(excelbcom.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},101);
                }
            }
        });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode==101){
            if(grantResults[0]==PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(excelbcom.this,"Permission Not granted",Toast.LENGTH_LONG).show();
            }
        }
    }
            ...
            public void run() {
                ...
                try {
                                ...
                                FirebaseDatabase.getInstance().getReference().child("firstseminternals").updateChildren(parentmap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            dialog.dismiss();
                                            Toast.makeText(excelbcom.this,"Marksheet Uploaded Successfully",Toast.LENGTH_LONG).show();
                                        }else {
                                            dialog.dismiss();
                                            Toast.makeText(excelbcom.this,"Marksheet not uploaded",Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
                            }
                    ...
                    //show the error if file is empty
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                dialog.dismiss();
                                Toast.makeText(excelbcom.this,"File is empty",Toast.LENGTH_LONG).show();
                ...
                //show the error message if failed due to file not found
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(excelbcom.this,e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
                }
