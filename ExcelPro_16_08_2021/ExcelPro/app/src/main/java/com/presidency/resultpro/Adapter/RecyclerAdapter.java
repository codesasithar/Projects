package com.presidency.resultpro.Adapter;
...
public  class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ...
        holder.nameTextView.setText(currentTeacher.getRegisternumber());
        holder.descriptionTextView.setText(currentTeacher.getPassword());
