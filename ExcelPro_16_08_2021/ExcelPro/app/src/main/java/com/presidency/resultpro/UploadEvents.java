...
public class UploadEvents extends AppCompatActivity {
    ...
    public static final String Database_Path = "Events";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(UploadEvents.this);
        ...
        DisplayImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(UploadEvents.this, EventsActivity.class);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (taskSnapshot.getMetadata() != null) {
                                if (taskSnapshot.getMetadata().getReference() != null) {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            .addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onFailure(@NonNull Exception exception) {
                                                    ...
                                                    Toast.makeText(UploadEvents.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                                                }
                                            });
                                    ...
                                    Toast.makeText(UploadEvents.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
