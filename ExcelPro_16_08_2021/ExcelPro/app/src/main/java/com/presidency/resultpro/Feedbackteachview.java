...
public class Feedbackteachview extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feedbackteachview);
        TextView fetchedtext = findViewById(R.id.fetchedText);
        rootRef = FirebaseDatabase.getInstance().getReference();

        // Database reference pointing to demo node
        demoRef = rootRef.child("ExcelPro").child("FEEDBACKSTeachers");
