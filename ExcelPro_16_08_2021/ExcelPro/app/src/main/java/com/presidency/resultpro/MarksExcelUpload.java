...
public class MarksExcelUpload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marks_excel_upload);
       ...
       view=findViewById(R.id.viewall);
        ...
        excel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ActivityCompat.checkSelfPermission(MarksExcelUpload.this , Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    selectfile();
                }
                else {
                    ActivityCompat.requestPermissions(MarksExcelUpload.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},101);
                }
            }
        });
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MarksExcelUpload.this,ShowAllImagesFromStorage.class));
            }
        });
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode==101){
            if(grantResults[0]==PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(MarksExcelUpload.this,"Permission Not granted",Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void readfile(final Uri file)
    {
        ...
        dialog.setMessage("Uploading Mark list");
            ...
            public void run() {
                ...
                try {
                    ...
                    if(rowscount>0){
                        ...
                        for (int r=0;r<rowscount;r++){
                            ...
                            if(row.getPhysicalNumberOfCells()==cellCount) {
                                //get cell data
                                String A = getCellData(row,2,formulaEvaluator);
                                String B = getCellData(row,4,formulaEvaluator);
                                ...
                                dialog.dismiss();
                                Toast.makeText(MarksExcelUpload.this,"row no. "+(r+1)+" has incorrect data",Toast.LENGTH_LONG).show();
                                return;
                            }
                        }
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                FirebaseDatabase.getInstance().getReference().child("InternalMarksTOC").
                                        child(timestamp).updateChildren(parentmap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            dialog.dismiss();
                                            Toast.makeText(MarksExcelUpload.this,"Uploaded Successfully",Toast.LENGTH_LONG).show();
                                        }else {
                                            dialog.dismiss();
                                            Toast.makeText(MarksExcelUpload.this,"Something went wrong",Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
                            }
                    ...
                    //show the error if file is empty
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                dialog.dismiss();
                                Toast.makeText(MarksExcelUpload.this,"File is empty",Toast.LENGTH_LONG).show();
                ...
                //show the error message if failed due to file not found
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(MarksExcelUpload.this,e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
                }
