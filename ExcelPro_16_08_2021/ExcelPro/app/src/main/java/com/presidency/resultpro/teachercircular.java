...
public class teachercircular extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teachercircular);
        ...
        demoRef = rootRef.child("ExcelPro").child("FacultyNotifications").child(currentDateandTime);
