...
public class internalverify extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_internalverify);
        TextView fetchedtext = findViewById(R.id.fetchedtext6);
        rootRef = FirebaseDatabase.getInstance().getReference();

        // Database reference pointing to demo node
        demoRef = rootRef.child("firstseminternals");
